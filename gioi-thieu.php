...
<head>
    ...
    <title>Tôi là Gold | Trần Khánh Dư.</title>
    ...
    <body id="body" class="view_width_100 view_height_100 overflow_auto ">
        <header id="header" class="width_x100">
            <nav id="NavBar">
    <div
        ...
        <div style="height: 58px;" class="container display_flex content_between items_center">
            ...
            <ul class="height_x100 display_flex margin_bottom_0" medium-screen="display_none"
                ...
                <li class="cursor_pointer height_x100  text_uppercase padding_x_3 margin_x_1 
                     border_brand border_bottom_2 ">
                    <a href="gioi-thieu"
                        class="text_capitalize height_x100 display_flex items_center
                     text_bolder text_brand text_black"
...
<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 8.29289C5.68342 7.90237 6.31658 7.90237 6.70711 8.29289L12 13.5858L17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289C19.0976 8.68342 19.0976 9.31658 18.7071 9.70711L12.7071 15.7071C12.3166 16.0976 11.6834 16.0976 11.2929 15.7071L5.29289 9.70711C4.90237 9.31658 4.90237 8.68342 5.29289 8.29289Z" />
               ...
               <a href="nhat-ki"
                   class="text_capitalize height_x100 display_flex items_center
                text_black"
                   hover-select="text_danger">Nhật Kí</a>
           </li>
    ...
    <div class="container">
		...
		<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M13.0962 18.2554L12 19.2126L10.9038 18.2554C6.98842 14.8366 5 11.8112 5 9C5 5.02141 8.10349 2 12 2C15.8965 2 19 5.02141 19 9C19 11.8112 17.0116 14.8366 13.0962 18.2554ZM5.68555 14.8034C6.09614 15.3656 6.55352 15.9373 7.05748 16.519C5.19525 16.9384 4 17.5337 4 18C4 18.807 7.57914 20 12 20C16.4209 20 20 18.807 20 18C20 17.5337 18.8047 16.9384 16.9425 16.519C17.4465 15.9373 17.9039 15.3656 18.3144 14.8034C20.5633 15.4858 22 16.5804 22 18C22 20.5068 17.5203 22 12 22C6.47973 22 2 20.5068 2 18C2 16.5804 3.43674 15.4858 5.68555 14.8034ZM12 4C14.8038 4 17 6.13816 17 9C17 11.047 15.3727 13.5659 12 16.556C8.62733 13.5659 7 11.047 7 9C7 6.13816 9.19624 4 12 4ZM12 6C13.6569 6 15 7.34315 15 9C15 10.6569 13.6569 12 12 12C10.3431 12 9 10.6569 9 9C9 7.34315 10.3431 6 12 6ZM11 9C11 8.44772 11.4477 8 12 8C12.5523 8 13 8.44772 13 9C13 9.55228 12.5523 10 12 10C11.4477 10 11 9.55228 11 9Z" />
            ...
            <section class="container_fuild padding_top_6 padding_bottom_0">
                <div class="width_x100">
                    <img style="max-height:100vh!important;" class="width_x100 object_cover" src="img/image/image/about.jpg" alt="Tôi là Gold | Trần Khánh Dư." loading="lazy">
                </div>
                <div class="container padding_top_4">
                    <h1 class="text_8">Tôi là Gold | Trần Khánh Dư.</h1>
                    <p class="text_italic margin_bottom_0">Gold là tôi, tôi có tâm hồn cho khoa học, một tâm hồn cho nghệ thuật.</p>
                </div>
            </section>
        </header>
        <main id="main" class="container padding_bottom_5">
            <section class="row">
                <div class="column display_flex padding_y_3">
                    <img class="square_5 rounded_circle margin_right_2 object_cover" src="img/image/image/logo-gold.png" alt="Trần Khánh Dư Logo">
                    <div>
                        <h2 class="text_4 margin_bottom_1 text_bolder">Trần Khánh Dư</h2>
                        <p class="text_4">Ngày 22 tháng 11 năm 2020</p>
                    </div>

                </div>
                <div class="column display_flex items_center content_end" medium-screen="column_12 content_start">
		...
		<path fill="currentColor"
            ...
            <section>
                <h2>Tôi là Gold.</h2>
<p>
    Tôi là Gold, tên thật là Trần Khánh Dư. Tôi sinh ra và lớn lên tại một vùng quê nhỏ ở Hậu Giang đó chính là Long Mỹ. Tôi
    đam
    mê lập trình , thích thiết kế và viết những dòng cảm xúc tâm trạng hoặc cảm xúc lên trang cá nhân hoặc blog của
    mình.
</p>
<h2>
    Gold?
...
<p>
    Gold là một màu sắc đại diện cho hòa bình. Một tâm hồn cho khoa học, một tâm hồn cho nghệ thuật.
</p>
<ul>
    <li>
       - Nhân cách thứ nhất thích thiết kế, đam mê vẽ vời, viết sách làm văn, sáng tác nghệ thuật. Yêu cái đẹp, thích
        hoa, thích
        đọc chuyện ngôn tình nhưng quan trọng hơn viết lại những gì tôi trải nghiệm và hành trình của cuộc đời mình.
    </li>
    <li>
        - Nhân cách thứ hai thích tư duy logic, lập trình, suy nghĩ giải quyết vấn đề từ đơn giản đến phức tạp. Nhân cách
        này
        thích sự trải nghiệm, thích ngồi bên máy tính,đọc sách kinh tế và khám phá khoa học.
    </li>
    <li>
       Màu vàng mang ý nghĩa của sự  vui vẻ, phấn khởi. Màu của ánh nắng mặt trời lan tỏa cảm giác ấm áp, thích thú và khả năng hoạt động trí não.
Tuy nhiên, khi tức giận, hãy tránh xa không gian có màu vàng nếu không muốn năng lượng của mỗi người đều tăng cao gây ra tranh cãi.
    </li>
</ul>
<p>
    Gold còn là "bài hát" theo tiếng anh còn có nghĩa là một bài nhạc. Bài nhạc này tên là "Màu Vàng Của Bình Minh".
</p>
<p>
    Gold còn nằm trong một đôi đó chính là "Gold sắt". Gold sắt này có nghĩa là những nguyên tắc của bản thân, những
    nguyên tắc này nhằm rèn luyện bản thân, giúp bản thân cố gắng hằng ngày. Đôi lúc những nguyên tắc này lại quá nghiêm
...
<p>
    Nghề nghiệp chính của tôi là nghiên cứu và phát triển ứng dụng web tiến bộ.
    Bên cạnh đó tôi còn làm design, viết nội dung,blog và xây dựng thương hiệu.
</p>
<h2>
    Sản phẩm.
</h2>
<p>
    Gold Designer là sản phẩm của tôi. Tôi không biết giải thích thế nào thật sự nó rất khó hiểu. Nó là một nền tảng ứng dụng
    web
    tiến bộ. Tôi xây dựng nền tảng đó sau 5 năm nghiên cứu và đi thực tế với website. Năm 2020 tôi bắt đầu cuộc hành
    trình
    đầu tiên để xây dựng từng dòng code hơn sau 5 năm nghiên cứu. Nó đơn giản là web, là những gì bạn thấy. Còn những gì
    bạn
    không thấy, đó chính là những thứ tôi phải xây dựng một đời.
</p>
<h2>
    Hành trình.
</h2>
<p>
    Gold Designer chính là cuộc hành trình của tôi. Tôi đang xây dựng nó hằng ngày hằng giờ mà người khác không thấy được. Tôi
    không biết mình sẽ làm nó đến bao giờ nhưng tôi tin vào con đường tôi chọn và mình đang làm gì. Hằng ngày khi tôi
    thấy
    nền tảng đó càng ngày phát triển tôi luôn hài lòng với sự nỗ lực của chính mình.
</p>
<h2>
    Định hướng.
</h2>
<p>
    Tôi muốn phát triển Gold Designer thành một nền tảng có thể giúp mọi người trong công việc và cuộc sống hằng ngày. Tôi muốn
    giúp các doanh nghiệp có thể tiếp cận công nghệ số nhanh hơn. Tôi muốn giúp mọi người dỡ phải tốn thời gian hơn vào
    những việc có thể tự động hóa được và tôi muốn mọi thứ an toàn hơn.
</p>
<h2>
    Dòng đời.
</h2>
<p>
    Tôi chỉ là một bông hoa trong muôn ngàn loài hoa khác, không mong mình có thể kết quả, chỉ mong mình có thể góp
    tiếng
    thơm cho đời. Vì tôi biết cuộc đời cũng chỉ là một loài hoa,một giấc mộng. Nên tôi luôn tự nhắc mình là: "Hoa Mộng
    Vô
    Thường"
</p>
            </section>
