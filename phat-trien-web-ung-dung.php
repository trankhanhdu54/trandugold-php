...
<head>
    ...
    <title>Phát Triển Web - Ứng Dụng | Trần Khánh Dư.</title>
    ...
    <meta property="og:title" content="Phát Triển Web - Ứng Dụng | Trần Khánh Dư.">
    <meta property="og:url" content="phat-trien-web-ung-dung">
    ...
    <div class="container">
        ...
        <section class="container_fuild padding_bottom_0">
            <div class="width_x100">
                ...
                src="img/image/service/app.jpg"
                    alt="Phát Triển Web Ứng Dụng" loading="lazy">
            </div>
            <div class="container padding_top_4">
                <h1 class="text_8">Phát Triển Web Ứng Dụng</h1>
                <p class="text_italic margin_bottom_0">Web ứng dụng là một trang web cũng là một ứng dụng. Web ứng dụng chạy ở mọi hệ điều hành, mọi nền tảng.</p>
            </div>
        </section>
    </header>
    <main id="main" class="container">
        <section>
            <h2>Web ứng dụng, ứng dụng web tiến bộ.</h2>
<p>
    PWA ( Progress Web Application ) ứng dụng web tiến bộ là một phần mềm ứng dụng được phân phối qua nền tảng web. Với
    tôi web ứng là một niềm đam mê thật sự. Khi tôi (<a href="home" target="_blank" rel="noopener">@trandugold.com</a>) bắt đầu nghiên cứu và trải nghiệm đó. Tôi nhận thấy
    rằng đây thật sự là tương lai. Tôi đã làm từ phần mềm cho đến các ứng dụng đầu tiên, tôi nhận thấy rằng web ứng dụng
    sẽ con đường mình phải làm và tiến về phía trước giống như bạn đang tiến hóa trên một quá trình mới.
</p>
<h2>
    Nghiên cứu.
</h2>
<p>
    Có thể đây là một dịch vụ của công ty nhưng tôi không thể giải thích và nói dể hiểu để bạn hiểu rằng web ứng dụng là
    gì? Chỉ có sự trải nghiệm của chính bản thân tôi mới có thể nói lên điều bạn cần biết. Ứng dụng web tiến bộ là một
    website chạy trên mọi nền tảng ( OS, Android, Window ... ) và mọi hệ điều hành nếu hệ điều hành đó có thể cài đặt
    trình duyệt web. Nếu bạn muốn tìm hiểu nhiều hơn hãy đọc những bài viết từ tôi.
</p>
<h2>
    Phát triển.
</h2>
<p>
    2007 - 2010 - 2013 - 2015 - 2019. Hơn 10 cho sự phát triển và sẵn sàng website có thể chạy trên mọi hệ điều hành
    tương tự như một ứng dụng. Hành trình của tôi chỉ bắt đầu từ năm 2016 khi những ngày đầu tôi thấy được tương lai của
    ứng dụng web tiến bộ. "Azemis - Nền tảng phát triển ứng dụng web tiến bộ" chính câu slogan đã nói lên những việc
    chúng tôi sẽ xây dựng và phát triển trong tương lai.
</p>
<h2>
...
<ul>
    <li>
        - Hoạt động trên trình duyệt, thích hợp với mọi người dùng.
    </li>
    <li>
        - Phù hợp với cả máy tính để bàn, thiết bị di động, máy tính bảng hoặc những biểu mẫu chưa xuất hiện.
    </li>
    <li>
        - Nhanh hơn vì phụ thuộc vào máy chủ bạn đang xây dựng.
    </li>
    <li>
        - Kết nối độc lập nhờ "Service workers" cho phép sử dụng ngoại tuyến.
    </li>
    <li>
        - Trải nghiệm là ứng dụng thật sự.
    </li>
    <li>
        - Dễ dàng nâng cấp và cập nhập.
    </li>
    <li>
        - An toàn vì được phục vụ qua HTTPS.
    </li>
    <li>
        - Tái kết nối nhờ thông bảo đẩy từ web đăng ký.
    </li>
    <li>
        - Thân thiện với công cụ tìm kiếm, tiết kiệm tiền marketing và quảng cáo sản phẩm.
    </li>
    <li>
        - Chi phí rẻ hơn khi phát triển một ứng dụng.
    </li>
</ul>
<h2>
...
<ul>
    <li>
        - Trong câu slogan đã thể hiện được con đường chúng tôi đi.
    </li>
    <li>
        - Chúng tôi là những người có nhiều kinh nghiệm và đã phát triển lâu dài.
    </li>
    <li>
        - Thiết kế đẹp và sự trải nghiệm tinh tế.
    </li>
    <li>
        - Bạn có thể thấy được thực tế những dự án chúng tôi đã phát triển.
    </li>
</ul>
<blockquote style="text-align: center; border-left: .25rem solid #eceeef; padding: .5rem 1rem;">
    <p style="font-size: 18px;  color: #242442;">
        " Web ứng dụng - Tôi phải đi con đường này vì con đường này là một ước mơ còn dang dở của tôi. "</p>
