...
<head>
    ...
    <title>Tiểu Thuyết | Trần Khánh Dư.</title>
...
<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 8.29289C5.68342 7.90237 6.31658 7.90237 6.70711 8.29289L12 13.5858L17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289C19.0976 8.68342 19.0976 9.31658 18.7071 9.70711L12.7071 15.7071C12.3166 16.0976 11.6834 16.0976 11.2929 15.7071L5.29289 9.70711C4.90237 9.31658 4.90237 8.68342 5.29289 8.29289Z" />
    ...
    <div class="mask flex_center" style="background-color: rgba(0,0 , 0, 0.42   );">
        <div>
            <h1 class="text_white text_center text_8">Tiểu Thuyết</h1>
            <p class="text_white text_4 text_normal text_center">Trần Khánh Dư | Tiểu Thuyết</p>
        </div>
    ...
    <main id="main">
        ...
        <section id="novelsets" class="container padding_bottom_5">
            <div class="padding_y_3">
                <div class="padding_y_3">
                    <h2>Tiểu Thuyết</h2>
                    <p class="text_4 text_normal" medium-screen="padding_x_5">Tôi có một thế giới khác gọi là tiểu thuyết, tôi viết về một thế giới nào đó mà lòng tôi muốn mơ mộng.</p>
                </div>
            </div>
            ...
            <div class="row padding_top_0">
                ...
                <div class="column_3  margin_y_2 " medium-screen="column_6" small-screen="padding_x_1">
                    <div class="rounded border position_relative" style="padding-top: 133%">
                        <a class="mask">
                            <img class="width_x100 object_cover height_x100 rounded" src="img/image/blogset/time.jpg"
                                alt="Còn dang dở" loading="lazy">
                        </a>
                    </div>
                    <div class="padding_3">
                        <a 
                        class="text_capitalize text_5 text_bold text_black text_truncate_2">Vân Chi | Thời Gian Và Tất Cả </a>
                    </div>
                </div>
                ...
                <div class="column_3  margin_y_2 " medium-screen="column_6" small-screen="padding_x_1">
                    <div class="rounded border position_relative" style="padding-top: 133%">
                        <a class="mask">
                            <img class="width_x100 object_cover height_x100 rounded" src="img/image/blogset/money.jpg"
                                alt="Còn dang dở" loading="lazy">
                    ...
                    <div class="padding_3">
                        <a 
                        class="text_capitalize text_5 text_bold text_black text_truncate_2">Tiêu Viêm | Đồng Tiền Và Phía Sau </a>
                    </div>
                </div>
