...
<head>
    ...
    <title>Thiết Kế Website | Trần Khánh Dư.</title>
    ...
    <meta property="og:title" content="Thiết Kế Website | Trần Khánh Dư.">
...
<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 8.29289C5.68342 7.90237 6.31658 7.90237 6.70711 8.29289L12 13.5858L17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289C19.0976 8.68342 19.0976 9.31658 18.7071 9.70711L12.7071 15.7071C12.3166 16.0976 11.6834 16.0976 11.2929 15.7071L5.29289 9.70711C4.90237 9.31658 4.90237 8.68342 5.29289 8.29289Z" />
    ...
    <div class="container">
        ...
        <section class="container_fuild padding_bottom_0">
            <div class="width_x100">
                ...
                src="img/image/service/code.jpg"
                    alt="Thiết Kế Website" loading="lazy">
            </div>
            <div class="container padding_top_4">
                <h1 class="text_8">Thiết Kế Website</h1>
                <p class="text_italic margin_bottom_0">Nhận thiết kế website theo yêu cầu với giá cả hợp lý tùy từng trường hợp của khách hàng theo từng yêu cầu.</p>
            </div>
        </section>
    </header>
    <main id="main" class="container">
        <section>
            <h2>Website là gì?</h2>
<p>
    "Website là một trang mạng...". Đó là cách giải thích nó quá giống như "Mọt sách". Với tôi website là "bộ
    mặt của một cá nhân hoặc doanh nghiệp nào đó". Bạn có thể xem website của tôi <a href="home"
        target="_blank" rel="noopener" style="text-decoration: underline;">tại đây.</a>
</p>
<h2>Thiết Kế Website để làm gì?</h2>
<p>
    Website giúp bạn đưa doanh nghiệp bạn, sản phẩm của bạn, hồ sơ của bạn publish ra toàn cầu. Website giúp khách hàng
    tìm
    đến bạn tốt hơn, hiểu được bạn nhiều hơn, hiểu sản phẩm bạn rõ hơn và hiểu được giá trị những gì bạn đang làm nhiều
    hơn.
    Website là những gì bạn muốn người khác biết đến bạn, là "bộ mặt" của bạn trên Internet.
</p>
<h2>
    Thiết kế Website, Tại sao chọn chúng tôi?
</h2>
<p>
    Có lẽ những lời lẽ chẳng thể thuyết phục được bạn. Tôi sẽ tìm lý do để thuyết phục bạn. Bạn có thể nhìn vào những gì
    tôi
    làm, team tôi làm. Những gì chúng tôi là được và bạn sẽ hiểu giá trị của nó. Chúng tôi không dùng lời lẽ để thuyết
    phục
    người nào đó. Chúng tôi chỉ sử dụng sản phẩm và cách chúng tôi làm việc để thuyết phục bạn.
</p>
<h2>
    Chúng tôi thiết kế những loại hình website nào?
</h2>
<p>
    Chúng tôi nhận thiết kế website từ những website landing page cho đến các nền tảng hàng triệu người dùng, chúng tôi
    tự
    tin vào khả năng công nghệ của chúng tôi. Bạn cũng có thể thấy được những nền tảng tôi đang phát triển. Và đây là
    những
    loại website chúng tôi thiết kế và phát triển.
</p>
<ul>
    <li> ⚡ Website cá nhân ( Profile ). Cá nhân nhằm xây dựng thương hiệu cá nhân, thích hợp cho developer, photographer,
        blogger,
        vlog hay chỉ đơn giản là muốn đưa hồ sơ cá nhân lên mạng.</li>
    <li>
        ⚡ Website cửa hàng ( Store ). Các quán coffee, tiệm bánh, quán ăn, khách sạn, áo cưới nhắm đưa sản phẩm và dịch
        vụ của doanh nghiệp bạn tiếp cận đến khách hàng.
    </li>
    <li>
        ⚡ Website buôn bán ( Shop ). Bạn muốn bán hàng online và đưa các sản phẩm có thể tìm kiếm trên google.
    </li>
    <li>
        ⚡ Website doanh nghiệp - ( Business ). Đưa doanh nghiệp của bạn lên các trang mạng nhắm giới thiệu doanh nghiệp
        của bạn đến
        khách hàng và các nhà đầu tư.
    </li>
    <li>
        ⚡ Web Ứng dụng - ( PWA ). Ứng dụng web là công nghệ tiếp theo của thế hệ web. Giúp bạn phát triển một ứng dụng
        ngay trên
        website của bạn. Thân thiện hơn và tối ưu hơn.
    </li>
    <li>
        ⚡ Nền tảng Web.- ( Platform ). Xây dựng nền tảng, hệ thống ERP, CRM, HRM hoặc bạn muốn xây dựng một nên tảng
        thương mại điện
        tử. Giá trị doanh nghiệp nằm trên nền tảng bạn xây dựng nhằm hoạch định doanh nghiệp của chính bạn.
    </li>
</ul>
...
<ul>
    <li>
        ✔ Thiết kế đẹp và hiện đại, trải nghiệm người dùng tốt.
    </li>
    <li>
        ✔ Giá cả hợp lý theo từng nhu cầu khách hàng.
    </li>
    <li>
        ✔ SEO tốt, tốc độ tải trang siêu nhanh.
    </li>
    <li>
        ✔ Đội ngũ sáng tạo, chuyên nghiệp,đam mê học học và có trình độ chuyên môn tốt.
    </li>
    <li>
        ✔ Website được kết nối với các trang xã hội địa phương nhanh chóng.
    </li>
    <li>
        ✔ Bảo mật và SSL được tự động theo mỗi Website.
    </li>
    <li>
        ✔ Dịch vụ hỗ trợ tốt và nhiều dịch vụ giúp xây dựng thương hiệu và uy tín cho khách hàng.
    </li>
    <li>✔ Được nâng cấp và cập nhập thường xuyên từ nền tảng Azemis. Giúp website theo kịp xu hướng thời đại.</li>
</ul>

<blockquote style="text-align: center; border-left: .25rem solid #eceeef; padding: .5rem 1rem;">
    <p style="font-size: 18px;  color: #242442;">
        " Website như một người phụ nữ hiểu chuyện, càng nghiên cứu - tìm hiểu càng thấy hấp dẫn và thú vị."</p>
