...
<head>
    ...
    <title>Dịch Vụ | Trần Khánh Dư.</title>
    ...
    <meta property="og:title" content="Dịch Vụ | Trần Khánh Dư.">
...
<body id="body" class="view_width_100 view_height_100 overflow_auto">
    <header id="header" class="width_x100 padding_top_6_half">
        <nav id="NavBar">
            <div
                ...
                <div style="height: 58px;" class="container display_flex content_between items_center">
                 ...
                 ">
                            <a href="home" class="text_capitalize height_x100 display_flex items_center 
                     text_black " hover-select="text_danger">Trang Chủ</a>
                        </li>
                        <li class="cursor_pointer height_x100  text_uppercase padding_x_3 margin_x_1 
                      ">
                            <a href="gioi-thieu" class="text_capitalize height_x100 display_flex items_center
                     text_black" hover-select="text_danger">Giới Thiệu</a>
                        </li>
                     ...
                     border_brand border_bottom_2">
                            <a href="dich-vu" class="text_capitalize height_x100 display_flex items_center
                     text_bolder text_brand  text_black" hover-select="text_danger">Dịch Vụ
                        ...
                        <li class="cursor_pointer height_x100   text_uppercase padding_x_3 margin_x_1 
                     ">
                            <a href="lien-lac" class="text_capitalize height_x100 display_flex items_center
                     text_black" hover-select="text_danger">Liên Lạc</a>
                        </li>
        ...
        <section id="TabBar"
            class="display_none background_white z_index_9xx shadow_2 position_fixed width_x100 bottom_0 noselect"
            ...
            border_white ">
                        <a href="home" class="display_block padding_y_1">
                            ...
                            <div class="square_2 display_inline_block text_black">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"
            ...
            border_white ">
             ...
             border_brand ">
                        <a href="dich-vu" class="display_block padding_y_1">
                            <div class="square_2 display_inline_block text_brand ">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path fill="currentColor"
        ...
        <section class="position_relative">
            ...
            <div class="mask flex_center" style="background-color: rgba(0,0 , 0, 0.42   );">
                <div>
                    <h1 class="text_white text_center text_8">Dịch Vụ</h1>
                    <p class="text_white text_4 text_normal text_center">Trần Khánh Dư | Dịch Vụ</p>
                </div>
    ...
    <main id="main" class="container">
        ...
        <section id="service" class="" style="background-color: rgba(0, 0, 0, 0.02);">
            <div class="container padding_y_5">
                <div class="padding_y_3">
                    <div class="text_center padding_y_3">
                        <h2>Trần Khánh Dư - Dịch Vụ</h2>
                        <p class="text_4 text_normal" medium-screen="padding_x_5">Nhiều dịch vụ cho bạn lựa chọn.</p>
                    </div>
                </div>
                <div class="row display_flex">

                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="thiet-ke-website">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/website.jpg"
                                    alt="Thiết Kế Website" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Thiết Kế Website</h3>
                                <p class=" margin_0">Nhận thiết kế website theo yêu cầu với giá cả hợp lý tùy từng
                                    trường hợp của khách hàng theo từng yêu cầu.</p>
                    ...
                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="quang-cao-facebook">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/ads.jpg"
                                    alt="Quảng Cáo - Tiếp Thị" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Quảng Cáo - Tiếp Thị</h3>
                                <p class=" margin_0">Nhận quảng cáo facebook, quảng cáo google, tiếp thị số nhằm vào
                                    khách hàng mục tiêu.</p>
                    ...
                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="phat-trien-web-ung-dung">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/pwa.jpg"
                                    alt="Phát Triển Web Ứng Dụng" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Phát Triển Web Ứng Dụng</h3>
                                <p class=" margin_0">Web ứng dụng là một trang web cũng là một ứng dụng. Web ứng dụng
                                    chạy ở mọi hệ điều hành, mọi nền tảng.</p>
                    ...
                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="viet-noi-dung-content">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/branding.jpg"
                                    alt="Xây Dựng Thương Hiệu" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Xây Dựng Thương Hiệu</h3>
                                <p class=" margin_0">Từ thiết kế hình ảnh, đồ họa. Đến thiết kế website và phát triển
                                    website. Nội dung và quảng cáo facebook, google.</p>
                    ...
                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="xay-dung-thuong-hieu">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/platform.jpg"
                                    alt="Phát Triển Nền Tảng" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Phát Triển Nền Tảng</h3>
                                <p class=" margin_0">Xây dựng nền tảng, hệ thống ERP - CRM - HRM nhằm hoạch định tài
                                    nguyên doanh nghiệp.</p>
                    ...
                    <div class="column_4 padding_y_2" medium-screen="column_6" small-screen="column_12">
                        <div class="text_center border rounded width_x100 background_white height_x100 ">
                            <a href="trai-nghiem-nguoi-dung">
                                <img class="width_x100 object_cover height_2x" src="img/image/service/design.jpg"
                                    alt="Thiết Kế UI/UX" loading="lazy">
                            </a>

                            <div class="padding_3">
                                <h3 class=" padding_x_2 text_capitalize">Thiết Kế UI/UX</h3>
                                <p class=" margin_0">Thiết Kế UI/UX, thiết kế đồ họa, banner, logo... Thiết kế bản mẫu
                                    demo, mockup, hình ảnh quảng cáo sản phẩm.</p>
