...
<head>
    ...
    <title>Thiết Kế UI/UX | Trần Khánh Dư.</title>
    ...
    <meta property="og:title" content="Thiết Kế UI/UX | Trần Khánh Dư.">
    <meta property="og:url" content="viet-noi-dung-content">
...
<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 8.29289C5.68342 7.90237 6.31658 7.90237 6.70711 8.29289L12 13.5858L17.2929 8.29289C17.6834 7.90237 18.3166 7.90237 18.7071 8.29289C19.0976 8.68342 19.0976 9.31658 18.7071 9.70711L12.7071 15.7071C12.3166 16.0976 11.6834 16.0976 11.2929 15.7071L5.29289 9.70711C4.90237 9.31658 4.90237 8.68342 5.29289 8.29289Z" />
    ...
    <div class="container">
        ...
        <section class="container_fuild padding_bottom_0">
            <div class="width_x100">
                ...
                src="img/image/service/des.jpg"
                    alt="Thiết Kế UI/UX" loading="lazy">
            </div>
            <div class="container padding_top_4">
                <h1 class="text_8">Thiết Kế UI/UX</h1>
                <p class="text_italic margin_bottom_0">Thiết Kế UI/UX, thiết kế đồ họa, banner, logo... Thiết kế bản mẫu demo, mockup, hình ảnh quảng cáo sản phẩm.</p>
            </div>
        </section>
    </header>
    <main id="main" class="container">
        <section>
            <h2>Tổng quát</h2>
<p>
    Với tôi, thiết kế không chỉ đòi hỏi sự đẹp đẽ mà còn thông minh và sáng tạo. Với tính cách cầu toàn, tôi muốn thiết
    kế bất kỳ sản phẩm nào cũng cần sự hoàn hảo trong khả năng hiện tại.
</p>
<h2>
    Thiết Kế Logo.
</h2>
<p>
    Logo không chỉ là một hình ảnh đẹp mà còn phải ý nghĩa và truyền thông điệp đến khách hàng. Với nhiều thiết kế logo
    hiện nay giá cả tùy thuộc vào giờ làm việc của nhà thiết kế và yêu cầu của khách hàng.Với châm ngôn.
</p>
...
Dịch : Đơn giản là sự tinh tế cuối cùng. Dựa trên thông điệp đó, những thiết kế đơn giản mang nhiều thông điệp ý nghĩa
và có thể truyền mọi ý nghĩa đến khách hàng giúp chúng tôi chăm sóc tỉ mỉ từng logo cầu kỳ nhất khiến khách hàng tiếp
cận thương hiệu thân thiện nhất.
<h2>
    Thiết kế Hình Ảnh.
</h2>
<p>
    Với xã hội hiện đại, 1 hình ảnh thay ngàn lời nói. Hoặc bạn đã từng đọc kinh tế hình ảnh bạn sẽ hiểu được giá trị
    của hình ảnh. Với một hình ảnh đẹp, thiết kế chăm chút và tỉ mỉ sẽ là điều tiên quyết khiến khách hàng đưa ra quyết
    định mua hàng hay dùng sản phẩm của chính bạn.
</p>
<h2>
    Thiết kế Banner.
</h2>
<p>
    Kỹ thuật là kỹ năng thiết kế những Banner đẹp. Bạn cần có một trình độ kỹ thuật chuyên môn tốt để so sánh độ tương
    phản của màu sắc, tính cỡ chữ vừa phải với mắt người, hình ảnh hòa nguyện cùng những đồ họa chuyên nghiệp giúp nâng
    cao hình ảnh sản phẩm, hình ảnh thương hiệu.
</p>
<h2>
    Thiết Kế Poster.
</h2>
<p>
    Một không gian hiện đại bạn cần một Poster để trang trí hoặc truyền thông điệp đến cộng đồng. Một Poster đẹp không
    chỉ cần hình ảnh đẹp, mà cần sự sáng tạo cầu kỳ để đưa từng câu chữ vào tấm Poster để cảm thấy đơn giản nhất khiến
    người xem dễ hiểu nhất.
</p>
<h2>
    Thiết Kế Catalogue.
</h2>
<p>
    Catalogue thường mang thông điệp của công ty. Nơi truyền cảm hứng không chỉ cho khách hàng mà còn cho chính nhân
    viên của bạn. Catalogue mang giá trị sản phẩm thay bằng lời nói,hành trình và chặn đường mà công ty, doanh nghiệp
    từng bước chạm đến hành trình bạn đang thấy. Một catalogue đẹp và một thuyết kế chuyên nghiệp sẽ không bao giờ khiến
    bạn thất vọng khi khách hàng đọc từng sự trải nghiệm hành trình của doanh nghiệp bạn.
</p>

<blockquote style="text-align: center; border-left: .25rem solid #eceeef; padding: .5rem 1rem;">
    <p style="font-size: 18px;  color: #242442;">
        "Cảm ơn người thầy đầu tiên dạy tôi học thiết kế,Leonardo da Vinci."</p>
